...
public class ObavijestiPacijentiTest extends SeleniumTestWrapper {
    private final static Logger log = LoggerFactory.getLogger(ObavijestiPacijentiTest.class);
    ...
    public void setup(@NotNull TestInfo testInfo) throws ClassNotFoundException, InterruptedException {
        ...
        healthElements.obrisiObavijestPacijent(PacijentContent.PACIJENT_ID, PacijentContent.DOKTOR_ID);
        healthElements.dodajTermin2();
        healthElements.dodajObavijest2();
    ...
    public void Ispravnost_Prikaza_Obavijesti() throws ClassNotFoundException {
        softAssertions.assertThat(obavijestiLjecniciPage.vratiNaslovObavijesti()).isEqualTo(ObavijestiContent.NASLOV_OBAVIJESTI_PACIJENT);
        softAssertions.assertThat(obavijestiLjecniciPage.vratiSadrzajObavijesti()).isEqualTo(ObavijestiContent.SADRZAJ_OBAVIJESTI_PACIJENT);
