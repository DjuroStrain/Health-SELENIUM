...
public class DatabaseCalls {
        ...
        try (Connection con = getConnection(); Statement stmt = con.createStatement()){
            ...
            String SQL =
                    "exec sp_executesql N'SET NOCOUNT ON;  INSERT INTO [AspNetUsers] ([Id], [AccessFailedCount], [ConcurrencyStamp], [DateOfBirth], [Discriminator], [Email], [EmailConfirmed], [FirstName], [LastName], [LockoutEnabled], \n" +
                            ...
                            "@p21 bit,@p22 nvarchar(450),@p23 time(7),@p24 time(7),@p25 int,@p26 bit,@p27 nvarchar(450),@p28 time(7),@p29 time(7),@p30 int,@p31 bit,@p32 nvarchar(450),@p33 time(7),@p34 time(7)',\n" +
                            "\n" +
                            "@p0=0,@p1=1,@p2=N'e9fbae22-ea0c-4f52-9618-2717e8f53046',@p3='00:00:00',@p4='00:00:00',@p5=1,@p6=1,@p7=N'e9fbae22-ea0c-4f52-9618-2717e8f53046',@p8='08:00:00',@p9='14:00:00',@p10=2,@p11=1,@p12=N'e9fbae22-ea0c-4f52-9618-2717e8f53046',@p13='08:00:00',\n" +
                            "@p14='14:00:00',@p15=3,@p16=1,@p17=N'e9fbae22-ea0c-4f52-9618-2717e8f53046',@p18='14:00:00',@p19='20:00:00',@p20=4,@p21=1,@p22=N'e9fbae22-ea0c-4f52-9618-2717e8f53046',@p23='14:00:00',@p24='20:00:00',@p25=5,@p26=1,@p27=N'e9fbae22-ea0c-4f52-9618-2717e8f53046',\n" +
                            "@p28='14:00:00',@p29='20:00:00',@p30=6,@p31=1,@p32=N'e9fbae22-ea0c-4f52-9618-2717e8f53046',@p33='00:00:00',@p34='00:00:00'";
        ...
        try(Connection con = getConnection(); Statement stmt = con.createStatement()) {
            ...
            String SQL =
                        "exec sp_executesql N'SET NOCOUNT ON;  INSERT INTO [MainService].[Services] ([Description], [DoctorId], [Name], [Price], [SpecializationId]) \n" +
                                ...
                                "\n" +
                                "@p0=N'Opis pregleda',@p1=N'e9fbae22-ea0c-4f52-9618-2717e8f53046',@p2=N'Pregled',@p3=52.00,@p4=1\n";
    ...
    * */
    public void dbConnectionDodajTermin() throws ClassNotFoundException {
        ...
        System.out.println(vrijemeTerminaOd);
        try (Connection con = getConnection(); Statement stmt = con.createStatement()){

            String SQL =
                    "DECLARE @date datettime2, @date2 datetime2\n" +
                            ...
                            "@p8 nvarchar(4000)',\n" +
                            "\n" +
                            "@p0=N'Bolest',@p1=N'Duro Belacic',@p2=N'e9fbae22-ea0c-4f52-9618-2717e8f53046',@p3=N'Ivan Horvat',@p4=N'71221338-035c-4be6-a8e5-cc8ff885db3e',\n" +
